...
function ya(a){return!!a&&(a.classList.contains("glue-footer__global-links-list-item")||a.classList.contains("h-c-footer__global-links-list-item"))}function oa(a,c){var b=a.category,d=a.siteId;return function(f){return f.category===b&&f.siteId===d&&f.eea===c}}function qa(){return arguments}function Q(a,c,b){var d={};return qa("consent",a,(d.ad_storage=(void 0===b?0:b)?"granted":"denied",d.analytics_storage=(void 0===c?0:c)?"granted":"denied",d))}
